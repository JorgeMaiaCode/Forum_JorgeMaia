...
//    function it_can_be_Upvoted(User $owner)
//    {
//        $this->upvote($owner);
//        $this->upvotes()->shouldBe(1);
//
//        $events = $this->releaseEvents();
//        $events->shouldHaveCount(1);
//        $events[0]->shouldBeAnInstanceOf(AnswerWasUpvoted::class);
//    }

//    function it_can_be_Downvoted(User $owner)
//    {
//        $this->downvote($owner);
//        $this->downvotes()->shouldBe(-1);
//
//        $events = $this->releaseEvents();
//        $events->shouldHaveCount(1);
//        $events[0]->shouldBeAnInstanceOf(AnswerWasDownvoted::class);
//    }
